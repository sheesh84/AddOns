...
RDDB["The Lich King"] = {
	[604] = { -- Ciudadela de la Corona de Hielo 
		...
		69248, -- Gas inmundo
		72219, -- Hinchaz�n g�strica
		69278, -- Espora de gas
		},
		["Rotface"] = {
		order = 6, ejid = nil,
		69674, -- Infecci�n mutada
		69508, -- Pulverizador de babas
		30494, -- Moco pegajoso
		},
		["Professor Putricide"] = {
		order = 7, ejid = nil,
		70215, -- Hinchaz�n gaseosa
		72454, -- Peste mutada
		...
		72151, -- Sed de sangre fren�tica
		71340, -- Pacto de los Ca�do Oscuro
		72985, -- Sombras enjambradoras
		70923, -- Frenes� incontrolable
		},
		["Valithria Dreamwalker"] = {
		order = 10, ejid = nil,
		70873, -- Vigor esmeralda
		70744, -- R�faga de �cido
		70751, -- Corrosi�n
		70633, -- Pulverizador de tripas
		71941, -- Pesadillas retorcidas
		70766, -- Estado on�rico
		},
		["Sindragosa"] = {
		order = 11, ejid = nil,
		70107, -- Escalofr�o penetrante
		70106, -- Helado hasta los huesos
		69766, -- Inestabilidad
		71665, -- Asfixia
		70126, -- Se�al de Escarcha
		...
		["Trash"] = {
		order = nil, ejid = nil,
		70980, -- Trampa ar�cnida
		70450, -- Espejo de sangre
		71089, -- Pus burbujeante
		69483, -- Expiaci�n oscura
		71163, -- Devorar humanoide
		71127, -- Herida mortal
		70435, -- Descuartizar
		70671, -- Putrefacci�n parasitante
	...
	[543] = { -- Prueba del Cruzado 
		...
		66013, -- Fr�o penetrante
		66012, -- Tajo congelante
		},
		["Acidmaw"] = {
		order = nil, ejid = nil,
		66819, -- V�mito ac�dulo
		66821, -- V�mito de arrabio
	...
	[535] = { -- Naxxramas 
		...
		["Maexxna"] = {
		order = 3, ejid = nil,
		28622, -- Trampa ar�cnida
		54121, -- Veneno necr�tico
		},
		["Noth the Plaguebringer"] = {
		order = 4, ejid = nil,
		29213, -- Maldici�n del Pesteador
		29214, -- C�lera del Pesteador
		29212, -- Entorpecer
		},
		["Heigan the Unclean"] = {
		order = 5, ejid = nil,
		29998, -- Fiebre decr�pita
		29310, -- Perturbaci�n de hechizo
		},
	...
	[529] = { -- Ulduar 
		...
		61903, -- Golpe de fusi�n
		61912, -- Perturbaci�n est�tica
		},
		["Kologarn"] = {
		order = 6, ejid = nil,
		64290, -- Agarre p�treo
		...
		["Freya"] = {
		order = 8, ejid = nil,
		62532, -- Apret�n de conservador
		62589, -- Furia de la naturaleza
		62861, -- Ra�ces f�rreas
		},
		["Hodir"] = {
		order = 9, ejid = nil,
		62469, -- Congelar
		61969, -- Congelaci�n apresurada
		62188, -- Fr�o cortante
		},
		["Mimiron"] = {
		order = 10, ejid = nil,
		63666, -- Concha de Napalm
		62997, -- Explosi�n de plasma
		64668, -- Campo magn�tico
		},
		["Thorim"] = {
		order = 11, ejid = nil,
		62042, -- Martillo de tormenta
		62130, -- Golpe desequilibrante
		62526, -- Detonaci�n de runa
		...
		order = nil, ejid = nil,
		62310, -- Empalar
		63612, -- Ense�a de rel�mpagos
		63615, -- Devastar armadura
		62283, -- Ra�ces f�rreas
