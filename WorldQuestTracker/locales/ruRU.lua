...
L["S_GROUPFINDER_ACTIONS_CANCEL_APPLICATIONS"] = "щелкните, чтобы отменить предложения..."
L["S_GROUPFINDER_ACTIONS_CANCELING"] = "отмена..."
L["S_GROUPFINDER_ACTIONS_CREATE"] = "Группа не найдена? нажмите кнопку, чтобы начать"
L["S_GROUPFINDER_ACTIONS_CREATE_DIRECT"] = "создать группу"
L["S_GROUPFINDER_ACTIONS_LEAVEASK"] = "Покинуть группу?"
L["S_GROUPFINDER_ACTIONS_LEAVINGIN"] = "Покидание из группы через (нажмите, чтобы выйти сейчас):"
L["S_GROUPFINDER_ACTIONS_RETRYSEARCH"] = "повторить поиск"
L["S_GROUPFINDER_ACTIONS_SEARCH"] = "Нажмите для поиска группы"
L["S_GROUPFINDER_ACTIONS_SEARCH_RARENPC"] = "поиск группы для убийства рарника"
...
L["S_GROUPFINDER_ACTIONS_SEARCHMORE"] = "нажмите для поиска новых членов группы"
L["S_GROUPFINDER_ACTIONS_SEARCHOTHER"] = "Покинуть и искать другую группу?"
L["S_GROUPFINDER_ACTIONS_UNAPPLY1"] = "нажмите, чтобы отменить заявку для создания новой группы"
...
L["S_GROUPFINDER_AUTOOPEN_RARENPC_TARGETED"] = "Авто-открытие при взятии в цель рарника"
L["S_GROUPFINDER_ENABLED"] = "Авто-открытие для нового задания"
L["S_GROUPFINDER_INVASION_ENABLED"] = "Авто-открытие на точке вторжения"
L["S_GROUPFINDER_LEAVEOPTIONS"] = "Настройки выхода из группы"
L["S_GROUPFINDER_LEAVEOPTIONS_AFTERX"] = "Покинуть,через X секунд"
L["S_GROUPFINDER_LEAVEOPTIONS_ASKX"] = "Без авто-выхода, просто спросить через X секунд"
L["S_GROUPFINDER_LEAVEOPTIONS_DONTLEAVE"] = "Не показывать панель выхода"
L["S_GROUPFINDER_LEAVEOPTIONS_IMMEDIATELY"] = "Выходить сразу, после завершения задания"
L["S_GROUPFINDER_NOPVP"] = "Избегать PVP-серверов"
...
L["S_GROUPFINDER_RESULTS_APPLYING"] = "Осталось %d групп, нажмите снова"
L["S_GROUPFINDER_RESULTS_APPLYING1"] = "Осталась 1 группа, нажмите снова"
...
L["S_GROUPFINDER_RIGHTCLICKCLOSE"] = "ПКМ для закрытия"
...
L["S_MAPBAR_AUTOWORLDMAP_DESC"] = [=[Находясь в Даларане или Оплоте класса, нажатие на 'M" открывает карту Расколотых островов.
...
L["S_RAREFINDER_TOOLTIP_SPOTTEDBY"] = "Обнаружил"
